...
insert  into `item_detail_master`(`id`,`item_name`,`item_unit`,`item_type`,`machine_number`,`item_quantity`,`created_by`,`created_on`,`updated_by`,`updated_on`) values (1,'Lime Powder',1,1,NULL,2,1,'2019-03-27 20:26:23',3,'2019-03-29 20:45:16'),(2,'Acid',1,1,NULL,2,1,'2019-03-27 20:29:55',3,'2019-04-04 16:31:19'),(5,'Phenyl',2,1,NULL,3,1,'2019-03-27 21:53:46',3,'2019-04-04 16:37:19'),(6,'charcoal',1,1,'',0,3,'2019-04-05 14:46:06',1,'2019-04-23 18:03:18'),(7,'Fogging Machine',3,2,'10023',1,1,'2019-04-23 18:24:27',1,'2019-04-23 18:34:49');
...
insert  into `user_infromation`(`user_id`,`user_name`,`user_pass`,`login_type`,`user_auth`,`delstatus`,`profile_ext`) values (1,'tarun','soyetra','admin','3,1,2,4,6,9,7',0,NULL),(2,'abhishek','abhi','admin','3,2,1,4',0,''),(3,'ak','theone','admin','3,1,2,4,6,7',0,'');
